...
namespace Mutation.Halo.TagGroups.Tags
{
    ...
    [TagGroupDefinitionAttribute(cacheFileSize: 52, tagFileSize: 76, version: 1, groupTag: "*eap", parentGroupTag: "", name: "scenario_weapons_resource", minimumVersion: EngineVersion.Halo2Xbox, maximumVersion: EngineVersion.Halo2Vista)]
    public class scenario_weapons_resource_block
    {
        ...
        [EngineVersionAttribute(min: EngineVersion.Halo2Xbox, max: EngineVersion.Halo2Vista)]
        public tag_block<scenario_weapon_palette_block> palette;
        
        [EditorMarkUpAttribute(displayName: "Objects")]
        [EngineVersionAttribute(min: EngineVersion.Halo2Xbox, max: EngineVersion.Halo2Vista)]
        public tag_block<scenario_weapon_block> objects;
