...
namespace Mutation.Halo.TagGroups.Tags
{
    ...
    [TagGroupDefinitionAttribute(cacheFileSize: 52, tagFileSize: 76, version: 1, groupTag: "*qip", parentGroupTag: "", name: "scenario_equipment_resource", minimumVersion: EngineVersion.Halo2Xbox, maximumVersion: EngineVersion.Halo2Vista)]
    public class scenario_equipment_resource_block
    {
        ...
        [EngineVersionAttribute(min: EngineVersion.Halo2Xbox, max: EngineVersion.Halo2Vista)]
        public tag_block<scenario_equipment_palette_block> palette;
        
        [EditorMarkUpAttribute(displayName: "Objects")]
        [EngineVersionAttribute(min: EngineVersion.Halo2Xbox, max: EngineVersion.Halo2Vista)]
        public tag_block<scenario_equipment_block> objects;
