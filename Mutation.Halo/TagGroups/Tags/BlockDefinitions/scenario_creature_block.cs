...
namespace Mutation.Halo.TagGroups.Tags
{
    ...
    [TagBlockDefinitionAttribute(cacheFileSize: 52, tagFileSize: 52, alignment: 4, maxBlockCount: 128)]
    public class scenario_creature_block
    {
        
        [EditorMarkUpAttribute(displayName: "Type")]
        [BlockIndexAttribute(blockName: "scenario_creature_palette_block")]
