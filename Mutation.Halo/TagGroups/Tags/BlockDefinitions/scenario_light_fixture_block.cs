...
namespace Mutation.Halo.TagGroups.Tags
{
    ...
    [TagBlockDefinitionAttribute(cacheFileSize: 84, tagFileSize: 84, alignment: 4, maxBlockCount: 500)]
    public class scenario_light_fixture_block
    {
        
        [EditorMarkUpAttribute(displayName: "Type")]
        [BlockIndexAttribute(blockName: "scenario_light_fixture_palette_block")]
        ...
        [EditorMarkUpAttribute(displayName: "light_fixture data")]
        [TagStructAttribute()]
        [EngineVersionAttribute(min: EngineVersion.Halo2Xbox, max: EngineVersion.Halo2Vista)]
        public scenario_light_fixture_struct_block light_fixture_data;
    }
    #endregion
    
    #region scenario_light_fixture_struct_block
    [TagBlockDefinitionAttribute(cacheFileSize: 24, tagFileSize: 24, alignment: 4, maxBlockCount: 1)]
    public class scenario_light_fixture_struct_block
    {
        ...
        [EditorMarkUpAttribute(displayName: "Intensity")]
        [EngineVersionAttribute(min: EngineVersion.Halo2Xbox, max: EngineVersion.Halo2Vista)]
