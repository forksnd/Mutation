...
namespace Mutation.Halo.TagGroups.Tags
{
    ...
    [TagBlockDefinitionAttribute(cacheFileSize: 56, tagFileSize: 64, alignment: 4, maxBlockCount: 64)]
    public class bitmap_block_reference_block
    {
        ...
        [EditorMarkUpAttribute(displayName: "bitmap blend method")]
        [EngineVersionAttribute(min: EngineVersion.Halo2Xbox, max: EngineVersion.Halo2Vista)]
        public e_bitmap_blend_method bitmap_blend_method;
        
        [EditorMarkUpAttribute(displayName: "initial sprite frame")]
        [EngineVersionAttribute(min: EngineVersion.Halo2Xbox, max: EngineVersion.Halo2Vista)]
        public short initial_sprite_frame;
        
        [EditorMarkUpAttribute(displayName: "top-left")]
        [EngineVersionAttribute(min: EngineVersion.Halo2Xbox, max: EngineVersion.Halo2Vista)]
        public Point2d top_left;
        
        [EditorMarkUpAttribute(displayName: "horiz texture wraps/second")]
        [EngineVersionAttribute(min: EngineVersion.Halo2Xbox, max: EngineVersion.Halo2Vista)]
        public float horiz_texture_wraps_second;
        
        [EditorMarkUpAttribute(displayName: "vert texture wraps/second")]
        [EngineVersionAttribute(min: EngineVersion.Halo2Xbox, max: EngineVersion.Halo2Vista)]
        public float vert_texture_wraps_second;
        ...
        [EditorMarkUpAttribute(displayName: "sprite animation speed fps")]
        [EngineVersionAttribute(min: EngineVersion.Halo2Xbox, max: EngineVersion.Halo2Vista)]
        public float sprite_animation_speed_fps;
        
        [EditorMarkUpAttribute(displayName: "progress bottom-left")]
        [EngineVersionAttribute(min: EngineVersion.Halo2Xbox, max: EngineVersion.Halo2Vista)]
        public Point2d progress_bottom_left;
        
        [EditorMarkUpAttribute(displayName: "string identifier")]
        [EngineVersionAttribute(min: EngineVersion.Halo2Xbox, max: EngineVersion.Halo2Vista)]
        public string_id string_identifier;
        ...
        [EditorMarkUpAttribute(displayName: "progress scale")]
        [EngineVersionAttribute(min: EngineVersion.Halo2Xbox, max: EngineVersion.Halo2Vista)]
        public RealVector2d progress_scale;
        ...
        public enum b_flags : uint
        {
            ...
            [EditorMarkUpAttribute(displayName: "ignore for list skin size calculation")]
            ignore_for_list_skin_size_calculation = 0x1,
            
            [EditorMarkUpAttribute(displayName: "swap on relative list position")]
            swap_on_relative_list_position = 0x2,
            
            [EditorMarkUpAttribute(displayName: "render as progress bar")]
            render_as_progress_bar = 0x4,
        }
        ...
        public enum e_bitmap_blend_method : short
        {
