...
namespace Mutation.Halo.TagGroups.Tags
{
    ...
    [TagBlockDefinitionAttribute(cacheFileSize: 36, tagFileSize: 52, alignment: 4, maxBlockCount: 64)]
    public class hud_block_reference_block
    {
        ...
        [EditorMarkUpAttribute(displayName: "starting bitmap sequence index")]
        [EngineVersionAttribute(min: EngineVersion.Halo2Xbox, max: EngineVersion.Halo2Vista)]
        public short starting_bitmap_sequence_index;
        ...
        public enum b_flags : uint
        {
            ...
            [EditorMarkUpAttribute(displayName: "ignore for list skin size")]
            ignore_for_list_skin_size = 0x1,
            
            [EditorMarkUpAttribute(displayName: "needs valid rank")]
            needs_valid_rank = 0x2,
        }
