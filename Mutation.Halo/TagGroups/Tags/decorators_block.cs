...
namespace Mutation.Halo.TagGroups.Tags
{
    ...
    [TagGroupDefinitionAttribute(cacheFileSize: 48, tagFileSize: 64, version: 1, groupTag: "DECP", parentGroupTag: "", name: "decorators", minimumVersion: EngineVersion.Halo2Xbox, maximumVersion: EngineVersion.Halo2Vista)]
    public class decorators_block
    {
